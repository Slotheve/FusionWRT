...
svn co https://github.com/xiaorouji/openwrt-passwall2
...
sed -i "s/OpenWrt /Slotheve @ FusionWrt /g" package/lean/default-settings/files/zzz-default-settings

# Test kernel 5.10
# sed -i 's/5.4/5.10/g' target/linux/x86/Makefile

echo -e " Slotheve's FusionWrt built on "$(date +%Y.%m.%d)"\n -----------------------------------------------------" >> package/base-files/files/etc/banner
